                    ...
                    visible.map((c) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-1 truncate text-[13px] font-semibold text-ink">{c.store}</div>
                          <div className="mt-0.5 text-[11.5px] text-mute">
                            {c.type} · {c.qty} pcs · {c.ageDays}d old
                            {c.priority ? " · HIGH" : ""}
                          </div>
                          {c.campaign ? (
                            <div className="mt-1.5 truncate rounded-md bg-paper px-2 py-1 text-[10.5px] font-medium text-ink-soft">
                              {c.campaign}
                            </div>
                          ) : null}
                            ...
                            <div className="mt-2.5 flex items-center gap-1.5 border-t border-line pt-2.5">
                              {primaryNext ? (
                                <button
                                  ...
                                  className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-ink px-2 py-1.5 text-[11.5px] font-semibold text-paper transition-colors hover:bg-sage disabled:opacity-50"
                                >
                                  {STATUS_LABEL[primaryNext]}
                                  <Icon name="arrow-right-linear" size={13} />
                                </button>
                              ) : null}
                              {others.length ? (
                                <Dropdown>
                                  <DropdownTrigger asChild>
                                    <button
                                      className="grid h-[26px] w-[26px] place-items-center rounded-lg border border-line-strong text-ink-soft hover:border-sage hover:text-sage"
