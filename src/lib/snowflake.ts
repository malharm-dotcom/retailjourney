...
export interface DistributionRow {
  ...
  /** UC's pack DATE — the packing stage is done. */
  PACKED_TIMESTAMP?: string | null;
  /** UC's dispatch — the manifest closed. Set where MANIFESTED_TIMESTAMP is not. */
  UC_DISPATCHED_TIMESTAMP: string | null;
...
SELECT
  ...
  QUANTITY, STORE, INVOICE_NUMBER, PACKED_TIMESTAMP, MANIFESTED_TIMESTAMP, UC_DISPATCHED_TIMESTAMP,
